...
import { enableClickjackingProtection, logClientAudit } from "@/lib/securityUtils";
...
export default function AdminUsers() {
  ...
  const updateUserStatus = async (userId: string, newStatus: string) => {
    try {
      // SEGURANÇA: Log de auditoria para ações administrativas
      logClientAudit('admin_user_status_change', {
        targetUserId: userId,
        newStatus,
